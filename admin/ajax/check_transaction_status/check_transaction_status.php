<?php
function c9wep_check_transaction_status_ajax_admin_fun(){
    $state='success';
    $msg='It is success';
    $data='';
    try {
...
add_action("wp_ajax_c9wep_check_transaction_status_ajax_admin_fun","c9wep_check_transaction_status_ajax_admin_fun");
// add_action("wp_ajax_nopriv_c9wep_check_transaction_status_ajax_admin_fun","c9wep_check_transaction_status_ajax_admin_fun");

function c9wep_check_transaction_status_ajax_js($hook) {
    ...
    if( strpos($hook,'page_cms90_northstar_newbook_settings') !== false){
        wp_enqueue_script( 'c9wep_check_transaction_status_ajax_js', plugins_url('/check_transaction_status.js', __FILE__),array('jquery'),1.0 );
...
// add_action( 'admin_enqueue_scripts', 'c9wep_check_transaction_status_ajax_js' );
