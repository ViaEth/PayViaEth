jQuery(document).ready(function ($) {
    ...
    function event_process(event){
        ...
        if('woocommerce_ethereumpay_check_live_connection'==_id){
            var network='main';
            var apikey=encodeURIComponent($("[name='woocommerce_ethereumpay_apikey']").val());
        }else if('woocommerce_ethereumpay_check_test_connection'==_id){
            var network=encodeURIComponent($("[name='woocommerce_ethereumpay_test_network']").val());
            var apikey=encodeURIComponent($("[name='woocommerce_ethereumpay_test_apikey']").val());
        }
