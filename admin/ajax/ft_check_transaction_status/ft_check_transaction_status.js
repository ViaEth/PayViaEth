jQuery(document).ready(function ($) {
    ...
    function event_process(event){
        ...
        var result_area=$(this);//note if you change something here, please update $("#refresh-status").on('ft_check_transaction_status_received',function(evt,res){ as well
    ...
    function ajax_call_ft_check_transaction_status(ajax_ele,post_data){
        $.ajax({
            ...
            datatype:'json',
            beforeSend:function(){
                    ft_check_transaction_status_updateTips(ajax_ele,'Loading...','ajax-going','color:#000');
                    },
    ...
    $("#refresh-status").on('ft_check_transaction_status_received',function(evt,res){
        // console.log(res);
